...
<div class="mb-4 d-flex align-items-center gap-3">
    ...
    <h4 class="fw-bold text-white mb-0" style="background: linear-gradient(120deg, #6c4ef6 0%, #4f7eff 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">Update Data Siswa</h4>
</div>
    ...
    <div class="col-lg-6">
        <div class="stat-card border-0 shadow-lg">
            <form method="POST" action="{{ route('admin.students.update', $student->id_student) }}">
                ...
                <div class="mb-3">
                    <label class="text-label mb-2 d-block">NIS (ID: #{{ $student->id_student }})</label>
